...
<!-- ============================================== COLOR: END ============================================== -->
	...
	<div id="category" class="category-carousel hidden-xs">
		<div class="item">	
			<div class="image">
				 <?php 
				 $sql=mysql_query("select categoryid  from subcategory where id='$cid'");
while($row=mysql_fetch_array($sql))
{
	$cidd = $row['categoryid'];
	
	 $sqld=mysql_query("select categoryName  from category where id='$cidd'");
while($rowd=mysql_fetch_array($sqld))
{
	$catsd = $rowd['categoryName'];
}
	if($catsd == "Bags")
	{
    ?>
		<img src="assets/images/banners/bags.fw.png" alt="" class="img-responsive">
			
	<?php
	}
	elseif($catsd == "Fashion")
	{
	?>
		<img src="assets/images/banners/fashion.fw.png" alt="" class="img-responsive">
	<?php
	}
	elseif($catsd == "Mens")
	{
	?>
		<img src="assets/images/banners/mens.fw.png" alt="" class="img-responsive">
	<?php
	}
	elseif($catsd == "Personal")
	{
	?>
		<img src="assets/images/banners/personal.fw.png" alt="" class="img-responsive">
	<?php
	}
	elseif($catsd == "Phone")
	{
	?>
		<img src="assets/images/banners/phone.fw.png" alt="" class="img-responsive">
	<?php
	}
	elseif($catsd == "Womens")
	{
	?>
				<img src="assets/images/banners/womens.fw.png" alt="" class="img-responsive">
	<?php
	}
	else
	{
...
while($row=mysql_fetch_array($sql))
{
    ?>
					...
					<div class="excerpt hidden-sm hidden-md">
						<font color="white"><?php echo htmlentities($row['subcategory']);?></font>
					</div>
			<?php } ?>
