...
<html lang="en">
	<head>
	    ...
	    <title>Fashion HAUL Boutique Home Page</title>
...
<div id="hero" class="homepage-slider3">
	<div id="owl-main" class="owl-carousel owl-inner-nav owl-ui-sm">
		<div class="full-width-slider">	
			<div class="item" style="background-image: url(assets/images/sliders/banner1.jpg);">
				<!-- /.container-fluid -->
			</div><!-- /.item -->
	    ...
	    <div class="full-width-slider">
		 ...
		 <div class="full-width-slider">
			<div class="item full-width-slider" style="background-image: url(assets/images/sliders/banner3.jpg);">
			</div><!-- /.item -->
		</div><!-- /.full-width-slider -->
