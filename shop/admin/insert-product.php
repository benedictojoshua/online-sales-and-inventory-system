...
$sql=mysql_query("insert into products(category,subCategory,productName,productCompany,productPrice,productDescription,shippingCharge,productStock,productAvailability,productImage1,productImage2,productImage3,productPriceBeforeDiscount) values('$category','$subcat','$productname','$productcompany','$productprice','$productdescription','$productscharge','$productstock','$productavailability','$productimage1','$productimage2','$productimage3','$productpricebd')");
...
<?php $query=mysql_query("select * from company");
while($row=mysql_fetch_array($query))
{?>
...
<div class="controls">
<input type="text"    name="productpricebd" onkeypress="return isNumberKey(event)" placeholder="Enter Product Price" class="span8 tip" required>
</div>
</div>
...
<div class="controls">
<input type="text"    name="productprice" onkeypress="return isNumberKey(event)"  placeholder="Enter Product Price" class="span8 tip" required>
</div>
</div>
...
<div class="controls">
<input type="text"    name="productShippingcharge" value="100" readonly placeholder="Enter Product Shipping Charge" class="span8 tip" required>
</div>
</div>
...
<div class="controls">
<input type="text"  name="productStock" onkeypress="return isNumberKey(event)" placeholder="Enter Product Stocks" class="span8 tip" required>
</div>
</div>
