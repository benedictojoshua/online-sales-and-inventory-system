...
$t1="23:59:59";
$to=date('Y-m-d')." ".$t1;
 $result = mysql_query("SELECT * FROM Orders where orderDate Between '$from' and '$to' AND paymentMethod!='null'");
...
?>
									...
									<li>
										...
										<?php	
	$status='Delivered';									 
$ret = mysql_query("SELECT * FROM Orders where paymentMethod!='null'");
...
<?php } ?>
						...
						<ul class="widget widget-menu unstyled">
                                <li><a href="sales.php"><i class="menu-icon icon-tasks"></i> Sales Report </a></li>
